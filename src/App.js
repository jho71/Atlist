    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          <Route exact path='/modifyuser' render={() => (<UserPage />)} />
...
const Home = () => {
  return (
    ...
    <Col sm="12" md={{ size: 6, offset: 3 }}>
      ...
      <a href='/movies'><h2 className="home">Movies</h2></a>
      <a href='/books'><h2 className="home">Books</h2></a>
      <a href='/shows'><h2 className="home">TV Shows</h2></a>
    </Col>
  </Row>
  </div>
  )
