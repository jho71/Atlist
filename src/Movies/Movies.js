  ...
  const Header = () => {
    ...
    return (
      <div> 
        ...
        <Link className='btn btn-default' to={`/movies/page/11`}><label>11</label></Link>
        <Link className='btn btn-default' to={`/movies/page/12`}><label>12</label></Link>
        <Link className='btn btn-default' to={`/movies/page/13`}><label>13</label></Link>
        <Link className='btn btn-default' to={`/movies/page/14`}><label>14</label></Link>
        <Link className='btn btn-default' to={`/movies/page/15`}><label>15</label></Link>
        <Link className='btn btn-default' to={`/movies/page/16`}><label>16</label></Link>
        <Link className='btn btn-default' to={`/movies/page/17`}><label>17</label></Link>
        <Link className='btn btn-default' to={`/movies/page/18`}><label>18</label></Link>
        <Link className='btn btn-default' to={`/movies/page/19`}><label>19</label></Link>
        <Link className='btn btn-default' to={`/movies/page/20`}><label>20</label></Link>      
    </div>
    )
  }
